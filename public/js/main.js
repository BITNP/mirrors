...
$('#search_mirror').on('click', function () {
  let val = $("#input_search_mirror").val();
  window.location.href = '/?name=' + val;
});

$('#input_search_mirror').keyup(function (event) {
  if (event.keyCode == 13) {
    $("#search_mirror").trigger("click");
  }
});
...
$('#input_search_help').keyup(function (event) {
  if (event.keyCode == 13) {
    $("#search_help").trigger("click");
  }
});

$('#search_mirror_name').on('click', function () {
  let val = $("#input_search_mirror_name").val();
  window.location.href = '/?name=' + val;
});

$('#input_search_mirror_name').keyup(function (event) {
  if (event.keyCode == 13) {
    $("#search_mirror_name").trigger("click");
  }
});