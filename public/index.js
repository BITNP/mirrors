...
if(window.location.pathname == '/') {
  ...
  $('article').click(function(){
      window.location.href = '/twits/' + $('article').index(this);
  });

}


function sendTwit(Text, Author) {
  $.ajax('/pushTwit',{
       data:{
          text: Text,
          author: Author
...
function insertNewTwit(twitText, twitAuthor) {
  ...
  var twit = { text: twitText, author: twitAuthor };
  var twitElem = Handlebars.templates.twit(twit);
